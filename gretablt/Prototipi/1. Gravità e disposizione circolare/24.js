...
export function sketch() {
    ...
    const material = new THREE.MeshBasicMaterial( { color: 0x000000, envMap: textureCube } );
     const loader = new THREE.CubeTextureLoader()
    ...
    pieceMaterials.push(new THREE.MeshStandardMaterial({ color: pieceColors[i], roughness: 1, envMap: textureCube }))
    }
    ...
    const planeMaterial = new THREE.MeshStandardMaterial({ color: 0x444444, roughness: 1 })
